...
class Address(models.Model):
    ...
    address_name = models.CharField(_('Address Name'), max_length=64, blank=True, help_text="Ex: Home")
    first_name = models.CharField(_('First Name'), max_length=64, blank=True)
    last_name = models.CharField(_('Last Name'), max_length=64, blank=True)
    company_name = models.CharField(_('Company Name'), max_length=64, blank=True)

    # db_index=True
    phone_number = PossiblePhoneNumberField(blank=True, default="", verbose_name=_('Phone'))
    ...
    city = models.CharField(_('City'), max_length=64, blank=True, help_text="Ex: Los Angeles")
    city_area = models.CharField(_('City Area'), max_length=64, blank=True, help_text="Ex: California")

    # country model sonra eklenecek
...
class CustomerUser(models.Model):
    ...
    phone_number = PossiblePhoneNumberField(blank=True, default="", verbose_name='Phone')
...
def upload_supplier_image(instance, filename):
    ...
    return f'suppliers/{instance.user}/main_image.{extension}'
...
class SupplierUser(models.Model):
    ...
    # Contact Fields
    phone_number = PossiblePhoneNumberField(blank=True, default="", verbose_name=_('Phone'))
    fax_number = PossiblePhoneNumberField(blank=True, default="", verbose_name=_('Fax'))
    ...
    def save(self, *args, **kwargs):
        try:
            ...
            self.country = Country.objects.get(id=DEFAULT_COUNTRY_ID)
        super(SupplierUser, self).save(*args, **kwargs)
